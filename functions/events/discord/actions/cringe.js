  ...
  await lib.discord.channels['@0.1.2'].messages.create({
    ...
    content:
      author.id === context.params.event.author.id
        ? `<@${author.id}> feeling...`
        : `<@${context.params.event.author.id}> something <@${author.id}>`,
    embed: {
      image: {url: data.url},
      color: 0xffc0cb,
    },
